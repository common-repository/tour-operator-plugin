...
class tourMap extends WP_Widget {
	function __construct() {
		parent::__construct(false, 'Legacy Tour Map', array('description' => 'Displays the starting point stored in TourCMS using Google Maps. Only visible on Tour/Hotel pages.'));	
	}
